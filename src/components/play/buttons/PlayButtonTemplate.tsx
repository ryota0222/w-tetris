...
// 正方形
export const SquarePlayButtonTemplate = forwardRef<
  HTMLButtonElement,
  SquareProps
>(({ role, onClick, active, children, allowLongPress }, ref) => {
...
// 横長
export const RectanglePlayButtonTemplate = forwardRef<
  HTMLButtonElement,
  RectangleProps
>(({ onClick, active, role, ratio = 1, children }, ref) => {
  const w = useMemo(() => {
    if (ratio === 1) {
